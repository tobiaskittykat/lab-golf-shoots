        ...
        <div className="rounded-2xl border border-accent/30 bg-card overflow-hidden">
          ...
          <CollapsibleContent>
            <div className="px-4 pb-4 space-y-4">
              {/* Editable prompt */}
              <div className="space-y-2">
                <label className="text-xs font-semibold text-foreground uppercase tracking-wide">Generation Prompt</label>
                <Textarea
                  ...
                  className="min-h-[100px] text-sm font-mono bg-muted/30 border border-border resize-y leading-relaxed"
                />
