            ...
            <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {Array.from({ length: campaignData.count }).map((_, i) => (
                  <div
                    key={i}
                    className="aspect-square bg-gradient-to-br from-secondary to-muted rounded-2xl flex items-center justify-center border border-border hover:border-primary/30 transition-colors cursor-pointer"
                  >
